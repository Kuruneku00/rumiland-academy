...
export class RumilandDB extends Dexie {
  ...
  constructor() {
    ...
    this.version(1).stores({
      ...
      financeTransactions: 'id, type, category, transaction_date, student_id, registration_id, payment_id',
    ...
    this.version(2).stores({
      financeTransactions:
        'id, type, category, transaction_date, student_id, registration_id, payment_id',
      recurringExpenses:
